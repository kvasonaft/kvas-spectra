    ...
    for type_name, data_2 in data_1.items():
        ...
        if type_name == 'Control':
            ...
            for i, (sample, data_3) in enumerate(data_2.items(), start = 1):
                ...
                results = peaks_finder_3.peaks_finder_3(waves, absorption, targets=target, delta=20, ax=None, plot=False, square=False, savgol_window=27, baseline_square='horizontal_full')
